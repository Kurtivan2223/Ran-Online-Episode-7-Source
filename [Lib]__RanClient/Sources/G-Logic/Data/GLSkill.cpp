...
namespace COMMENT
{
	...
	std::string SKILL_TYPES[SKILL::FOR_TYPE_SIZE] = 
	{
		...
		"HP Transformation Rate",
		"MP Transformation Rate",
		"SP Transformation Rate",

		"Defence Transformation Rate",
		"Detoxify",
		"Hit Rate Transformation",
		"Prevention Transformation Rate",
		"HP+MP+SP Transformation Rate",
		...
		"Pet Pickup All Item",	// PetData
		"Pet Pickup Rare Item",
		"Pet Pickup Potion Item",
		"Pet Pickup Money",
		"Pet Pickup Stone Item",
		"Pet HP Heal",
		"Pet HP+MP+SP Heal",
		"Pet Help Attack",
		"Pet Help Defense ",
		"Pet Auto Use Potion",
		"Pet Prevent Item Drop",
		"Changed Resistance"
	};
